...
create table test2 (
	...
	mid varcgar(20) not null, 							-- dvd 대여한 사람의 아이디
...
insert into test2 values (default, '아침의 제국','hkd1234', default, default, default);
insert into test2 values (default, '프로그램과의전쟁','kms1234', '교양', default, default);
insert into test2 values (default, '오늘이가면','lkj1234','교양', '2021-4-15', default);
